...
int main(int argc, char *argv[])
{
	...
	width = 100;
	height = 100;
	plane_arr_f = new unsigned char[100 * 100 * 3];
	texture_arr = new unsigned char[100 * 100 * 3];
	arr = new unsigned char[300 * 300 * 3];
	...
	// glut functions.  
	glutInit(&argc, argv);
	glutInitWindowPosition(300, 300); // Where the window will display on-screen.
