...
Sphere *sp=new Sphere(-30,-210,20,60,sph2_c,false,false,'s',1);
objects[ind]= sp;
ind+=1;
sp=new Sphere(30,-30,50,20,sph1_c,false,false,'s',1);
objects[ind]= sp;
ind+=1;
...
Triangle *t=new Triangle(T_P0,T_P1,T_P2,tri_c1,true,true,'t',1.5);
objects[ind]=t;
...
t=new Triangle(T_P0,T_P1,T_P2,tri_c2,true,true,'t',1.5);
objects[ind]=t;
objects[ind]->normal(Pe);
ind++;
...
t=new Triangle(T_P0,T_P1,T_P2,tri_c3,true,true,'t',1.5);
objects[ind]=t;
objects[ind]->normal(Pe);
ind++;
...
stbi_write_jpg("mesh-fresnel.jpg",200,200,3,plane_arr_f,100);
}
