...
float s,t,u;
// s=magnitude(T_A1.x,T_A1.y,T_A1.z)/magnitude(A.x,A.y,A.z);
// t=magnitude(T_A2.x,T_A2.y,T_A2.z)/magnitude(A.x,A.y,A.z);
// u=magnitude(T_A0.x,T_A0.y,T_A0.z)/magnitude(A.x,A.y,A.z);
